// This file is part of Riot Emergence Proxy Headers Utillities.
//
...
//
// Riot Emergence Proxy Utillities is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with Riot Emergence Proxy  Headers Utillities.  If not, see <http://www.gnu.org/licenses/>.
...
func TestXForwardedHandler_ServeHTTP_Success(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
...
func TestXForwardedHandler_ServeHTTP_failMustHaveXForwardedHostWithUndefinedErrorHandler(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
		Handler: http.HandlerFunc(DumpServeHTTP),
	}
...
func TestXForwardedHandler_ServeHTTP_failMustHaveXForwardedHost(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
		Handler:      http.HandlerFunc(DumpServeHTTP),
...
func TestXForwardedHandler_ServeHTTP_failMustHaveXForwardedFor(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
		Handler:      http.HandlerFunc(DumpServeHTTP),
		ErrorHandler: http.HandlerFunc(ErrorHandlerFunc),
	}
...
func TestXForwardedHandler_ServeHTTP_failMustHaveXForwardedProto(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
		Handler:      http.HandlerFunc(DumpServeHTTP),
		ErrorHandler: http.HandlerFunc(ErrorHandlerFunc),
	}
...
func TestXForwardedHandler_ServeHTTP_failInvalidXForwardedClientCert(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
		Handler:      http.HandlerFunc(DumpServeHTTP),
		ErrorHandler: http.HandlerFunc(ErrorHandlerFunc),
	}
...
func TestXForwardedHandler_ServeHTTP_failUndefinedHandler(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{}
...
func TestXForwardedHandler_GetError_failCalledOutsideErrorHandler(t *testing.T) {
	xfh := &proxyheaders.XForwardedHandler{
